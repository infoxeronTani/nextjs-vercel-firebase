        ...
        <Box id='content' className='padding-custom'>
          <Box sx={{ width: '100%' }}>
            ...
            <Typography variant='body1' gutterBottom>
              ...
              <TextField id='standard-basic' type='text' variant='standard' required name='date' value={date} />
              by and between &nbsp; &nbsp;
              <TextField
                id='standard-basic'
                variant='standard'
              ...
              of the Con dential Information (de ned below). Therefore, the parties agree as follows:
              <br />
              <br />
              1. For the purposes of this Agreement, “Con dential Information” shall mean any information disclosed by
              Break Free, whether in writing, orally, visually or otherwise, including but not limited to business
              plans, contractual, engineering, nancial, sales, marketing and operational information, product speci
              cations, technical data, trade secrets, know-how, ideas, subscription charges , platform charges, website
              details, subscription bene ts and concepts of Break Free or third parties. Con dential Information
              ...
              <br />
              <br />
              2. With respect to all Con dential Information disclosed hereunder, Recipient agrees that from and after
              the date of this Agreement, Recipient shall not: a) use the Con dential Information except for purposes of
              its business relationship with Break Free (the “Authorized Purpose”); or
              <br /> b) disclose the Con dential Information to any third party except:
              <br />
              (i) as may be authorized in writing in advance by an of cer of Break Free. <br />
              <br />
              3. Recipient shall require its Representatives who receive any Con dential Information to comply with the
              terms and conditions of this Agreement and Recipient shall be responsible for their compliance herewith.
              Recipient shall use at least the same degree of care to protect the con dentiality and ensure the proper
              use of the Con dential Information as Recipient uses with respect to its information of a similar kind or
              nature, but in no event less than reasonable care. <br />
              <br />
              4. Break Free grants no rights in or to the Con dential Information. All Con dential Information shall
              ...
              efforts to have such disclosures placed under a protective order or otherwise obtain con dential treatment
              of the Con dential Information.
              <br />
              <br />
              ...
              <br /> (i) deliver to Break Free and cease to use all Con dential Information in Recipient’s (including
              its Representatives’) possession, custody or control; or
              <br /> (ii) destroy the same and delete all electronic records containing the Con dential Information,
              provided that Break Free may require Recipient to certify in writing such destruction and deletion.
              <br />
              <br />
              9. Recipient agrees that money damages would not be a suf cient remedy for breach of this Agreement and
              that, in addition to all other remedies, Break Free shall be entitled to speci c performance and
              ...
              respect to the subject matter hereof. This Agreement may not be waived or modi ed except pursuant to a
              ...
              <br />
              <br />
              12. This Agreement shall bind and bene t the parties and their respective successors and assigns.
              Recipient’s obligations under this Agreement shall survive any termination hereof.
              <br />
              <br /> 13. This Agreement shall be governed by the laws applicable (excluding its con icts-of-laws
            ...
            <Box sx={{ width: '50%', maxWidth: '500' }}>
              ...
              <Box>
                <Typography variant='body1' gutterBottom>
                  <h3>
                    Title :
                    <TextField sx={{ pl: 3 }} id='standard-basic' disabled={true} variant='standard' value={'CEO'} />
                    <br />
                  </h3>
                </Typography>
                ...
                <Typography sx={{ pl: 3 }}>
                  <h3>
                    ...
                    <TextField
                      ...
                      disabled={true}
                      variant='standard'
                      value={'SECOND FLOOR, HOUSE NUMBER 356'}
                    />
                    <br />
                    <TextField
                      id='standard-basic'
                      disabled={true}
                      variant='standard'
                      value={'SECTOR 45 , GURGAON, HARYANA, 122003'}
                    />
                  </h3>
                </Typography>
              </Box>
