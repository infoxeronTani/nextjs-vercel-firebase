          ...
          response
            ...
            .then((data) => {
              ...
              if (numberExists) {
                ...
                signInWithPhoneNumber(Client.auth, polishedPN, appVerifier)
        ...
        <React.Fragment>
          <LocalizationProvider dateAdapter={AdapterDateFns}>
            ...
            <p className={classes.BottomLine}>
              ...
              <span className={classes.SmallText}>Terms and Services</span>
              and
              <span className={classes.SmallText}> Privacy Policy</span>
            </p>
            <p className={classes.BottomLine}>
